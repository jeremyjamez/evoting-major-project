...
namespace eVotingApi.Migrations
{
    ...
    [Migration("20201227162651_ModifyFKInConstituency")]
    partial class ModifyFKInConstituency
    {
            ...
            modelBuilder.Entity("eVotingApi.Models.Member", b =>
                {
                    ...
                    b.Property<long?>("CandidateMemberId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("PoliticalPartyPartyId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PoliticalPartyPartyId");
            ...
            modelBuilder.Entity("eVotingApi.Models.Candidate", b =>
                {
                    b.HasOne("eVotingApi.Models.Constituency", "Constituency")
                        .WithOne("Candidate")
                        .HasForeignKey("eVotingApi.Models.Candidate", "ConstituencyId")
            ...
            modelBuilder.Entity("eVotingApi.Models.Member", b =>
                {
                    ...
                    b.HasOne("eVotingApi.Models.PoliticalParty", "PoliticalParty")
                        .WithMany("Members")
                        .HasForeignKey("PoliticalPartyPartyId");
